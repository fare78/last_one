<?php
/*i want to make some thing in my project 
i need admin when go to details he can calulate price of ordere 
i have table named printing_centers and table name delivery centers 
in printing centers there is column  id , name , contact_number , product price 
and in delivery_centers i have id ,name ,contact_number ,price
so i need in page order_details 
i can calc price 
how : i have in order_details page admin can choose which printing and deliver center will make order so depending on his choice there is new options diplayed to him which is product of printing center he choose 
so after choose delivery and printing and product 
he can type number of product needed 
printing price = product ( printing table ) * amount
delivery price = price ( from delivery table)
and total price = price*amount + delivery price  */
session_start();
